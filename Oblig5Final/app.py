...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # sti til directory med excel filer
...
def index():
    ...
    if form.validate_on_submit():
        ...
        excel_path = os.path.join(BASE_DIR, 'data', 'applications.xlsx')
        try:
...
def statistics():
    # Sti til Excel-filen
    excel_path = os.path.join(BASE_DIR, 'data', 'ssb-barnehager-2015-2023-alder-1-2-aar.xlsm')
